...
class SignUpEvent with _$SignUpEvent {
  ...
  const factory SignUpEvent.passwordChanged(String? passwordStr) =
      PasswordChanged;
  const factory SignUpEvent.firstNameChanged(String? firstNameStr) = FirstNameChanged;
  const factory SignUpEvent.lastNameChanged(String? lastNameStr) = LastNameChanged;
