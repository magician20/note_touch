    ...
    return Container( 
      child: Card(
        ...
        child: InkWell(
          ...
          // AutoRouter.of(context).innerRouterOf<StackRouter>(NotesRoute.name)!.navigate(PageFormRoute(id: 1));
           context.tabsRouter..setActiveIndex(0)..innerRouterOf<StackRouter>(NotesRoute.name)!.push(PageFormRoute(id: 1));
